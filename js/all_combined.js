var w = 3700;
		...
		var rect = svg.selectAll("rect")
					...
					.on("mouseover", function(d) {	
										...
										div.html("<font size=3>" + "<b>" + d[4] + "</b>" + "</font>" + "<br/>" + d[2] + "<br/>" + "<br/>" + "Winning Margin " + "&nbsp; " + d[5] + "<br/>" + "NTK " + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + d[6] + "<br/>" + "MNM "+ "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + d[7] + "<br/>" + "AMMKMNKZ " + "&nbsp; &nbsp; &nbsp; " + d[8])	
